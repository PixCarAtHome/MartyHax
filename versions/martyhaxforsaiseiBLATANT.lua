...
UtilityPage.Button(
    {
        ...
        Callback = function()
            ...
            game:GetService("CoreGui")["BLW"]:Destroy()
            wait(0.01)
            loadstring(game:HttpGet("https://raw.githubusercontent.com/PixCarAtHome/MartyHax/main/versions/martyhaxforsaiseiLITE.lua"))()
        end
    }
)
