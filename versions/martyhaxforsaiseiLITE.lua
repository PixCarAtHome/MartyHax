...
UtilityPage.Button(
    {
        ...
        Callback = function()
            ...
            game:GetService("CoreGui")["LIW"]:Destroy()
            wait(0.01)
            loadstring(game:HttpGet("https://raw.githubusercontent.com/PixCarAtHome/MartyHax/main/versions/martyhaxforsaiseiBLATANT.lua"))()
        end
    }
)
                            ...
                            for _, anim in next, anims do
                                if table.find(animIds, anim.Animation.AnimationId) then
                                    if AP:GetState() then
                                        if debounce == false then
                                            if
                                                (plrChar.HumanoidRootPart.Position - char.HumanoidRootPart.Position).Magnitude <=
                                                    parryDist and
                                                    plrChar.Humanoid.Health > 0 and
                                                    not plrChar.Humanoid.PlatformStand
                                             then
                                                parry()
                                            end
                                        end
...
TeleportsPage.Button(
    {
        ...
        Callback = function()
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                CFrame.new(-71.8545685, -266.542847, 858.611938, 1, 0, 0, 0, 1, 0, 0, 0, 1)
        end
    }
)
...
TeleportsPage.Button(
    {
        ...
        Callback = function()
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame =
                CFrame.new(-1838.29443, -634.047058, 508.572784, 1, 0, 0, 0, 1, 0, 0, 0, 1)
        end
    }
)
...
if syn then
    ...
    pcall(
        function()
            syn.protect_gui(game:GetService("CoreGui")["BLW"])
        end
    )
end
