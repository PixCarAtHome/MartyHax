...
local Themes = {
	...
	Drip = {
		...
		MaximiseAccent = Color3.fromRGB(0,255,110),
		NavBar = Color3.fromRGB(55,55,55),
		NavBarAccent = Color3.fromRGB(255,223,0),
		NavBarInvert = Color3.fromRGB(235,235,235),
		TitleBar = Color3.fromRGB(55,55,55),
		TitleBarAccent = Color3.fromRGB(255,255,255),
		...
		ButtonAccent = Color3.fromRGB(255,223,0),
		ChipSet = Color3.fromRGB(235,235,235),
		ChipSetAccent = Color3.fromRGB(255,223,0),
		DataTable = Color3.fromRGB(235,235,235),
		DataTableAccent = Color3.fromRGB(255,223,0),
		Slider = Color3.fromRGB(17,17,17),
		SliderAccent = Color3.fromRGB(255,223,0),
		Toggle = Color3.fromRGB(255,223,0),
		ToggleAccent = Color3.fromRGB(17,17,17),
		Dropdown = Color3.fromRGB(17,17,17),
		DropdownAccent = Color3.fromRGB(255,223,0),
		ColorPicker = Color3.fromRGB(17,17,17),
		ColorPickerAccent = Color3.fromRGB(255,223,0),
		TextField = Color3.fromRGB(17,17,17),
		TextFieldAccent = Color3.fromRGB(255,223,0)
	}
}
